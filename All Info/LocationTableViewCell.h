...
@property (weak, nonatomic) IBOutlet UIImageView *PrdoctImgView;
@property (weak, nonatomic) IBOutlet UILabel *AfterLocationLab;
@property (weak, nonatomic) IBOutlet UILabel *Prodectlabel;
